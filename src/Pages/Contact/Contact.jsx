  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="border border-[#E8E8E8] pb-5">
          ...
          <div className="bg-[#F3F3F3] w-[364px] h-[240px] flex justify-center items-center ml-6 ">
        ...
        >
          <fieldset className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 rounded-md shadow-sm">
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <ReCAPTCHA
                sitekey="6Lf03espAAAAAJPzaP3T7EzojTrrHuJLZkQ5qwxS"
                onChange={onChange}
              />
            </div>
          </fieldset>
