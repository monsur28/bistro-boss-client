    ...
    <div>
      ...
      >
        <div
          ...
          className="flex flex-col justify-center items-center lg:flex-row-reverse lg:gap-24 lg:my-20 p-5 lg:pb-10"
        >
          ...
          <div className=" max-w-md pt-10">
            ...
            >
              ...
              <div className="space-y-1 text-sm">
                <label className="block dark:text-gray-600 font-semibold">
                  PhotoURL
                </label>
                <input
                  type="text"
